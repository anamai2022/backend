...
--
-- Table structure for table `tbl_Loginyfhs`
--

DROP TABLE IF EXISTS `tbl_Loginyfhs`;
...
--
-- Dumping data for table `tbl_Loginyfhs`
--

LOCK TABLES `tbl_Loginyfhs` WRITE;
/*!40000 ALTER TABLE `tbl_Loginyfhs` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_Loginyfhs` ENABLE KEYS */;
UNLOCK TABLES;
