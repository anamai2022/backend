...
--
-- Table structure for table `tbl_UserQuestionAnswer`
--

DROP TABLE IF EXISTS `tbl_UserQuestionAnswer`;
...
--
-- Dumping data for table `tbl_UserQuestionAnswer`
--

LOCK TABLES `tbl_UserQuestionAnswer` WRITE;
/*!40000 ALTER TABLE `tbl_UserQuestionAnswer` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_UserQuestionAnswer` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-07-08 14:24:49
