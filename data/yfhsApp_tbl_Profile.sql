...
CREATE TABLE `tbl_Profile` (
  ...
  `f_vsion` varchar(300) DEFAULT NULL,
  ...
  `f_director` int(11) DEFAULT NULL,
  `f_physician` int(11) DEFAULT NULL,
  `f_responsiblePerson` int(11) DEFAULT NULL,
